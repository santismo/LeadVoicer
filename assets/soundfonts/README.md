...
Additional GM/retro banks in `index.html` are loaded from `bratpeki/soundfonts` as external GitHub raw URLs. That repo documents the included files as GitHub-size-safe and lists their licenses, including CC0 banks, GPLv2 TimGM, and public-domain eawpats.
